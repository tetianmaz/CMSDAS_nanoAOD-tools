...
class ZProducer(Module):
    def __init__(self, xsWeight_, isMC_, electronSelection, muonSelection, muonSelectionLoose, tauSelection, jetSelection, photonSelection):
    ...
    def analyze(self, event):
        ...
        if nMuon_>0:
          ...
          if nTau_>0:
             ...
             if self.isMC__:
                ...
                tauSFmuoup, tauSFmuo, tauSFmuodown = tauSFTool_muo.getSFvsEta(tauEta, Tau_genPartFlav_, unc='All')
        ...
        if self.isMC__:
           ...
           print "inside ZProducer, before"
           print self.xsWeight__
           print "inside ZProducer, after"
...
ZProducerConstr = lambda xsWeight, isMC : ZProducer(
   xsWeight_ = xsWeight,
   isMC_ = isMC,
