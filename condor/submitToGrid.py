...
for dataset in inputDatasets:
    ...
    f_bash.write('SCRAM_ARCH=slc7_amd64_gcc700; export SCRAM_ARCH\n')
    f_bash.write('scram list\n')
    f_bash.write('ls -alrth\n')
    ...
    f_bash.write('cp ./crab/keep_and_drop.txt ./\n')
    f_bash.write('python %s root://cmseos.fnal.gov//store/user/cmsdas/2023/long_exercises/ZTauTau/%s.root\n' % (runfile, dataset))
