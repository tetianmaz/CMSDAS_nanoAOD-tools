...
class ExampleAnalysis(Module):
    ...
    def analyze(self, event):
        ...
        if Tauh_exists & Tauele_exists:
            ...
            singlee = hlt.Ele24_eta2p1_WPTight_Gsf_LooseChargedIsoPFTauHPS30_eta2p1_TightID_CrossL1 #only measuring efficiency when both tauele and tauh exist.
            if singlee:
...
p = PostProcessor(".", files, cut=preselection, branchsel=None, modules=[
                  ExampleAnalysis()], noOut=False, histFileName="histeff1.root", histDirName="plots", maxEntries=1000)
p.run()
